...
function Feedback() {
  ...
  return (
    ...
    <h4><b>Feedback Resistered By :</b> {JSON.parse(localStorage.getItem("user")).name}</h4>
    ...
    <textarea type="text" cols="30" rows="10" placeholder='Feedback'
    ...
    <button className='primaryBtn4' id='post-btn' onClick={() => { postDetails() }}>Send</button>
